...
### Signature
```
(estimator: 'EstimatorLike', *, X_train: 'ArrayLike | None' = None, y_train: 'ArrayLike | None' = None, X_test: 'ArrayLike | None' = None, y_test: 'ArrayLike | None' = None, train_data: 'dict | None' = None, test_data: 'dict | None' = None, pos_label: 'PositiveLabel | None' = None) -> 'None'
```
