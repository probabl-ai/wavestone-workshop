...
```python
skore.evaluate(estimator: 'EstimatorLike | list[EstimatorLike] | dict[str, EstimatorLike]', X: 'ArrayLike | None' = None, y: 'ArrayLike | None' = None, data: 'dict | None' = None, *, splitter: "float | int | Literal['prefit'] | SKLearnCrossValidator | Generator | _DefaultType" = <DEFAULT>, pos_label: 'int | float | bool | str | None' = None, n_jobs: 'int | None' = None) -> 'EstimatorReport | CrossValidationReport | ComparisonReport'
```
