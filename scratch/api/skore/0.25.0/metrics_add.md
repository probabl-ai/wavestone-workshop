# skore metrics.add / metrics.get (custom metric plumbing)

Source: inspect: skore @ 0.25.0 (live EstimatorReport)
Probed: 2025-09-15
...
### Signature
```
(metric: 'MetricLike', *, name: 'str | None' = None, verbose_name: 'str | None' = None, greater_is_better: 'bool' = True, position: "Literal['first', 'last']" = 'first', **kwargs: 'Any') -> 'None'
```

### help()
```
Python Library Documentation: method add in module skore._sklearn._estimator.metrics_accessor

add(metric: 'MetricLike', *, name: 'str | None' = None, verbose_name: 'str | None' = None, greater_is_better: 'bool' = True, position: "Literal['first', 'last']" = 'first', **kwargs: 'Any') -> 'None' method of skore._sklearn._estimator.metrics_accessor._MetricsAccessor instance
...
### Signature
```
(name: 'str', data_source: 'DataSource' = 'test', **kwargs) -> 'Any'
```

### help()
```
Python Library Documentation: method get in module skore._sklearn._estimator.metrics_accessor

get(name: 'str', data_source: 'DataSource' = 'test', **kwargs) -> 'Any' method of skore._sklearn._estimator.metrics_accessor._MetricsAccessor instance
    Get a metric value.
